...
import { createFlatPromise } from './flat-promise.js';
...
var ConcurrencyGuard = /*#__PURE__*/function () {
  function ConcurrencyGuard(options) {
    _classCallCheck(this, ConcurrencyGuard);
    /** 运行中的 promise 对象 map */
    _defineProperty(this, "runningPromiseMap", new Map());
    /** 记录运行中的 promise 是否已被获取 */
    _defineProperty(this, "runningPromiseGettedMap", new Map());
    /** 缓存运行过的函数结果 */
    _defineProperty(this, "resultMap", new Map());
    /** 是否缓存函数运行结果 */
    _defineProperty(this, "cacheResult", false);
    var _ref = options || {},
   ...
   * ```
   */
  _createClass(ConcurrencyGuard, [{
    key: "call",
    value: (function () {
      var _call = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(key, asyncFn) {
        var _len,
          args,
          _key,
          _args = arguments;
    ...
    key: "apply",
    value: (function () {
      var _apply = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(key, asyncFn, args) {
    ...
    key: "waitResult",
    value: (function () {
      var _waitResult = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(key) {
    ...
    key: "run",
    value: (function () {
      var _run = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(runCtx) {
        var key,
          asyncFn,
          isCall,
