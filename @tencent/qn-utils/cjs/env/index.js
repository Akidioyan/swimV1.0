...
function ua() {
  ...
  var ua = userAgent || helper.isBrowser() && ((_window = window) === null || _window === void 0 || (_window = _window.navigator) === null || _window === void 0 ? void 0 : _window.userAgent);
...
exports.isDianPing = isDianPing;
exports.isHanvon = isHanvon;
exports.isHarmony = isHarmony;
exports.isHarmonyNext = isHarmonyNext;
exports.isIOS = isIOS;
exports.isIPad = isIPad;
exports.isIReader = isIReader;
exports.isOppoSystemBrowser = isOppoSystemBrowser;
exports.isQQ = isQQ;
exports.isVivoSystemBrowser = isVivoSystemBrowser;
exports.isWeixin = isWeixin;
exports.isWxApplets = isWxApplets;
exports.isXmly = isXmly;
