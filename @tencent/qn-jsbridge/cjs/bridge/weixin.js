...
var Weixin = /*#__PURE__*/function () {
  function Weixin() {
    var _this = this;
    _classCallCheck__default.default(this, Weixin);
    _defineProperty__default.default(this, "weixinJSBridge", null);
    /**
     * 分享给朋友 收藏
     * @param options
     */
    _defineProperty__default.default(this, "setShareInfo4Friend", function (options, onShare) {
      ...
      (_this$weixinJSBridge = _this.weixinJSBridge) === null || _this$weixinJSBridge === void 0 || _this$weixinJSBridge.on('menu:share:appmessage', function () {
        ...
        onShare === null || onShare === void 0 || onShare({
          target: _interface.ShareType.weixin,
          link: options.link
        });
     ...
     * @param options
     */
    _defineProperty__default.default(this, "setShareInfo4Timeline", function (options, onShare) {
      ...
      (_this$weixinJSBridge3 = _this.weixinJSBridge) === null || _this$weixinJSBridge3 === void 0 || _this$weixinJSBridge3.on('menu:share:timeline', function () {
        ...
        onShare === null || onShare === void 0 || onShare({
          target: _interface.ShareType.timeLine,
          link: options.link
        });
     ...
     * @param options
     */
    _defineProperty__default.default(this, "setShareInfo4QQ", function (options, onShare) {
      ...
      (_this$weixinJSBridge5 = _this.weixinJSBridge) === null || _this$weixinJSBridge5 === void 0 || _this$weixinJSBridge5.on('menu:share:qq', function () {
        ...
        onShare === null || onShare === void 0 || onShare({
          target: _interface.ShareType.qq,
          link: options.link
        });
     ...
     * @param options
     */
    _defineProperty__default.default(this, "setShareInfo4QZone", function (options, onShare) {
      ...
      (_this$weixinJSBridge7 = _this.weixinJSBridge) === null || _this$weixinJSBridge7 === void 0 || _this$weixinJSBridge7.on('menu:share:QZone', function () {
        ...
        onShare === null || onShare === void 0 || onShare({
          target: _interface.ShareType.qZone,
          link: options.link
        });
  ...
  _createClass__default.default(Weixin, [{
    key: "ready",
    value: function ready() {
      ...
      if (index.isClient() && typeof window.WeixinJSBridge !== 'undefined') {
        this.weixinJSBridge = window.WeixinJSBridge;
        return Promise.resolve(this);
      }
      if (index.isClient() && index.isInIframe()) {
        try {
          var weixinJSBridge = index.getParentWeixinJSBridge();
          if (weixinJSBridge) {
            this.weixinJSBridge = weixinJSBridge;
            return Promise.resolve(this);
          }
          // 300毫秒尝试一次，共尝试20次
          return index.waitForParentWeixinJSBridge(20, 300).then(function (weixinJSBridge) {
      ...
      var _setShareInfo = _asyncToGenerator__default.default( /*#__PURE__*/_regeneratorRuntime__default.default.mark(function _callee2(options, onShare) {
        ...
        return _regeneratorRuntime__default.default.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              imgUrl = options.imgUrl, restOptions = _objectWithoutProperties__default.default(options, _excluded);
